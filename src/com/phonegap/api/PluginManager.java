...
public final class PluginManager {	
	 ...
	 * @param ctx
	 */
	public PluginManager(PhonegapActivity ctx) {
						...
						public void run() {
							try {
								...
								// Check the success (OK, NO_RESULT & !KEEP_CALLBACK)
									...
									ctx.sendJavascript(callbackId, cr.toSuccessCallbackString(callbackId));
								} 
								
								// If error
								else {
									ctx.sendJavascript(callbackId, cr.toErrorCallbackString(callbackId));
								}
							} catch (Exception e) {
								e.printStackTrace();
	...
	*/
    ...
    /**
     * Load a plugin from a file or url.
     * 
     * @param url
     */
